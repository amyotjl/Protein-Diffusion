...
if __name__ == "__main__":
    ...
    parser.add_argument('-min', '--min_seq', type=int, help='minimum number of AA in a sequence to be part of the dataset', default=0, required=False)
    parser.add_argument('-max', '--max_seq', type=int, help='maximum number of AA in a sequence to be part of the dataset', default=0) # gets set in the function
